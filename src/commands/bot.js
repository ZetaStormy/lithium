exports.run = (client, msg, _args, _command, _content, Discord) => {
    ...
    var embed = new Discord.MessageEmbed()
        ...
        .setTimestamp()
        .setDescription(`
Actualmente el bot se encuentra en fase de pruebas y únicamente es usado por LiteriumNT, no obstante, puedes acceder al código fuente desde [Github](https://github.com/ZetaStormy/Lithium).
Lithium está bajo la licencia [GPL-3.0](https://github.com/ZetaStormy/Lithium/blob/community/LICENSE), por lo que es de código abierto y de libre uso.
